      ...
      <div className="">
        <div className="row d-flex m-0 banner align-items-center justify-content-center">
          <div className="col-md-6 col-sm-12">
            ...
            <Link to="/login">
              <button className="btn-primary btn p-3 fs-3  fw-light mx-3 mb-5">Join For Free</button>
              <button className="btn btn-light p-3 fw-light fs-3 mb-5">Try Online Campus For Children</button>
            </Link>
            </div>
        </div>
      </div>
